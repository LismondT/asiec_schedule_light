...
class SettingsBloc extends Bloc<SettingsEvent, SettingsState> {
  ...
  SettingsBloc(
      this.getSettings, this.saveSettings, this.getFields)
  ...
  void _onChangeRequestType(
      ChangeRequestTypeEvent event, Emitter<SettingsState> emit) async {
  ...
  void _onSelectRequestId(
      SelectRequestIdEvent event, Emitter<SettingsState> emit) {
